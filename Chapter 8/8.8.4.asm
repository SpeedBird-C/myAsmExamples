...
Comment !
 Write a program that compares the runtime speeds of
both the recursive Factorial procedure from Section 8.5.2 and the
nonrecursive Factorial procedure written for the preceding programming
exercise. Use the GetMseconds procedure from the book's link library
to measure and display the number of milliseconds required to call
each Factorial procedure several thousand times in a row.

NOTE: A nested loop is used because the running time of a single loop
	is less than a milisecond
!
...
Factorial PROC
;
; recursive Factorial procedure from Section 8.5.2
; Receives: Value of n pushed in the stack
